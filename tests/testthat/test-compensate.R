test_that("compensate & transform a GatingSet", {
      ...
      expect_equal(fsApply(gs_get_data(gs2), colMeans, use.exprs = TRUE), expectRes)
      ...
      expect_failure(expect_equal(fsApply(gs_get_data(gs3), colMeans, use.exprs = TRUE)
      ...
      expect_equal(fsApply(gs_get_data(gs4), colMeans, use.exprs = TRUE), expectRes)
      ...
      fs.trans.gs <- gs_get_data(gs.trans)
