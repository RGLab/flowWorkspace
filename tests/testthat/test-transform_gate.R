...
test_that("scale rectangleGate_gh", {
  ...
  expect_equal(scaled_gate, gh_get_gate(gh, test_rectangleGate_node))
})
...
test_that("shift polygonGate_gh", {
  ...
  expect_equal(shifted_gate, gh_get_gate(gh, test_polygonGate_node))
})
...
test_that("shift ellipsoidGate_gh", {
  ...
  expect_equal(shifted_gate, gh_get_gate(gh, test_ellipsoidGate_node))
})
...
test_that("shift rectangleGate_gh", {
  ...
  expect_equal(shifted_gate, gh_get_gate(gh, test_rectangleGate_node))
})
...
test_that("rotate polygonGate_gh", {
  ...
  expect_equal(rotated_gate, gh_get_gate(gh, test_polygonGate_node))
})
...
test_that("rotate ellipsoidGate_gh", {
  ...
  expect_equal(rotated_gate, gh_get_gate(gh, test_ellipsoidGate_node))
})
...
test_that("transform polygonGate_gh", {
  ...
  transformed_gate <- transform_gate(test_polygonGate, scale = test_scale_split, boundaries = new_polygon, 
                                     dx = c(dx2, dy2), deg = test_angle)
  expect_equal(transformed_gate, gh_get_gate(gh, test_polygonGate_node))
})
...
test_that("transform ellipsoidGate_gh", {
  ...
  transformed_gate <- transform_gate(test_ellipsoidGate, scale = test_scale_split, mean = new_center,
                                     dx = c(dx2, dy2), cov = new_cov, deg = test_angle)
  expect_equal(transformed_gate, gh_get_gate(gh, test_ellipsoidGate_node))
})
...
test_that("transform rectangleGate_gh", {
  ...
  transformed_gate <- transform_gate(test_rectangleGate, scale = test_scale_split, min = new_min, 
                                     dx = c(dx2, dy2), max = new_max)
  expect_equal(transformed_gate, gh_get_gate(gh, test_rectangleGate_node))
})
...
test_that("scale polygonGate_gs", {
  test_polygonGate <- gs_get_gate(gs, test_polygonGate_node)
  ...
  expect_equal(scaled_gate1, gs_get_gate(gs, test_polygonGate_node)[[1]])
  expect_equal(scaled_gate2, gs_get_gate(gs, test_polygonGate_node)[[2]])
})

test_that("scale ellipsoidGate_gs", {
  test_ellipsoidGate <- gs_get_gate(gs, test_ellipsoidGate_node)
  ...
  expect_equal(scaled_gate1, gs_get_gate(gs, test_ellipsoidGate_node)[[1]])
  expect_equal(scaled_gate2, gs_get_gate(gs, test_ellipsoidGate_node)[[2]])
})
...
test_that("scale rectangleGate_gs", {
  ...
  expect_equal(scaled_gate1, gs_get_gate(gs, test_rectangleGate_node)[[1]])
  expect_equal(scaled_gate2, gs_get_gate(gs, test_rectangleGate_node)[[2]])
})
...
test_that("shift polygonGate_gs", {
  ...
  expect_equal(shifted_gate1, gs_get_gate(gs, test_polygonGate_node)[[1]])
  expect_equal(shifted_gate2, gs_get_gate(gs, test_polygonGate_node)[[2]])
})
...
test_that("shift ellipsoidGate_gs", {
  ...
  expect_equal(shifted_gate1, gs_get_gate(gs, test_ellipsoidGate_node)[[1]])
  expect_equal(shifted_gate2, gs_get_gate(gs, test_ellipsoidGate_node)[[2]])
})
...
test_that("shift rectangleGate_gs", {
  ...
  expect_equal(shifted_gate1, gs_get_gate(gs, test_rectangleGate_node)[[1]])
  expect_equal(shifted_gate2, gs_get_gate(gs, test_rectangleGate_node)[[2]])
})
...
test_that("rotate polygonGate_gs", {
  ...
  expect_equal(rotated_gate1, gs_get_gate(gs, test_polygonGate_node)[[1]])
  expect_equal(rotated_gate2, gs_get_gate(gs, test_polygonGate_node)[[2]])
})
...
test_that("rotate ellipsoidGate_gs", {
  ...
  expect_equal(rotated_gate1, gs_get_gate(gs, test_ellipsoidGate_node)[[1]])
  expect_equal(rotated_gate2, gs_get_gate(gs, test_ellipsoidGate_node)[[2]])
})
...
test_that("transform polygonGate_gs", {
  ...
  transformed_gate2 <- transform_gate(test_polygonGate[[2]], scale = test_scale_split, boundaries = new_polygon, 
                                      dx = c(dx2, dy2), deg = test_angle)
  expect_equal(transformed_gate1, gs_get_gate(gs, test_polygonGate_node)[[1]])
  expect_equal(transformed_gate2, gs_get_gate(gs, test_polygonGate_node)[[2]])
})
...
test_that("transform ellipsoidGate_gs", {
  ...
  transformed_gate2 <- transform_gate(test_ellipsoidGate[[2]], scale = test_scale_split, mean = new_center,
                                      dx = c(dx2, dy2), cov = new_cov, deg = test_angle)
  expect_equal(transformed_gate1, gs_get_gate(gs, test_ellipsoidGate_node)[[1]])
  expect_equal(transformed_gate2, gs_get_gate(gs, test_ellipsoidGate_node)[[2]])
})
...
test_that("transform rectangleGate_gs", {
  ...
  transformed_gate2 <- transform_gate(test_rectangleGate[[2]], scale = test_scale_split, min = new_min, 
                                      dx = c(dx2, dy2), max = new_max)
  expect_equal(transformed_gate1, gs_get_gate(gs, test_rectangleGate_node)[[1]])
  expect_equal(transformed_gate2, gs_get_gate(gs, test_rectangleGate_node)[[2]])
})
