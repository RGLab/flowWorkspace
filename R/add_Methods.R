...
#' @param gh A \code{GatingHierrarchy} or \code{GatingSet}
#' @param gate A \code{filter} or a list of \code{filter}s to be added to the  \code{GatingHierarchy} or \code{GatingSet}.
...
pop_add.logical <- function(gate, gh, parent, name, recompute, cluster_method_name = NULL, ... )
          {
            ...
            nodeID <- .addGate(gh, fb, name = name, parent = parent, recompute = FALSE, ...)
