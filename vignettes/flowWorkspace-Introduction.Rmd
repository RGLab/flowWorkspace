...
```
If you want to dive into details and sub-steps of the parsing process, see [How to parse a GatingML](http://bioconductor.org/packages/release/bioc/vignettes/flowWorkspace/inst/doc/HowToParseGatingML.html).
