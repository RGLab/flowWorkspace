...
public:
	...
	trans_local getTransformation(wsRootNode,map<string,float> & gains,const compensation & comp, PARAM_VEC & transFlag,trans_global_vec*,biexpTrans * _globalBiExpTrans,linTrans * _globalLinTrans, bool prefixed);
