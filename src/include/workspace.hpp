...
public:
	 ...
	 virtual trans_local getTransformation(wsRootNode,map<string,float> & gains, const compensation &,PARAM_VEC &,trans_global_vec *,biexpTrans * _globalBiExpTrans,linTrans * _globalLinTrans, bool prefixed)=0;
