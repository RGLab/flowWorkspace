...
// load_gatingset
XPtr<GatingSet> load_gatingset(string path, bool readonly, vector<string> select_samples, bool verbose, string remote_path, List cred);
RcppExport SEXP _flowWorkspace_load_gatingset(SEXP pathSEXP, SEXP readonlySEXP, SEXP select_samplesSEXP, SEXP verboseSEXP, SEXP remote_pathSEXP, SEXP credSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< string >::type path(pathSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< string >::type remote_path(remote_pathSEXP);
    Rcpp::traits::input_parameter< List >::type cred(credSEXP);
    rcpp_result_gen = Rcpp::wrap(load_gatingset(path, readonly, select_samples, verbose, remote_path, cred));
    return rcpp_result_gen;
END_RCPP
}
// load_legacy_gs
...
RcppExport SEXP _flowWorkspace_write_to_disk(SEXP frSEXP, SEXP filenameSEXP, SEXP ish5SEXP, SEXP idSEXP, SEXP keySEXP, SEXP regionSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::XPtr<CytoFrameView> >::type fr(frSEXP);
    Rcpp::traits::input_parameter< string >::type filename(filenameSEXP);
    ...
    write_to_disk(fr, filename, ish5, id, key, region);
    return R_NilValue;
END_RCPP
}
// load_cf_from_h5
