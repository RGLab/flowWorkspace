 ...
 */
trans_local macFlowJoWorkspace::getTransformation(wsRootNode root,map<string,float> & gains,const compensation & comp, PARAM_VEC & transFlag,trans_global_vec * gTrans,biexpTrans * _globalBiExpTrans,linTrans * _globalLinTrans, bool prefixed){
